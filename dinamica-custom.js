                    ...
                    `<div class="col-lg-12 col-md-12 col-sm-12 d-flex align-items-stretch">
                        <div class="card shadow-sm" style="margin-bottom: 20px; cursor: pointer; border-radius: 15px; border: 1px solid #ddd; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                            <div class="card-body">
                                <div>
                                    <div class="col-12">
                                        <p class="card-text d-flex justify-content-between" style="font-size: small;"><span><strong>Lista:</strong> ${lista.Codigo}&nbsp;&nbsp;&nbsp;&nbsp;</span><span><strong>Emissão:</strong> ${formatDate(lista.DataEmissao)}&nbsp;&nbsp;&nbsp;&nbsp;</span><strong>Valor Total:</strong> ${formattedTotalValue}</p>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <div class="col-12">
                                                ...
                                                <p class="card-text d-flex justify-content-between"><span><strong>Qtd. Atendida:</strong> ${produto.QtdAtendida}&nbsp;&nbsp;&nbsp;&nbsp;</span><span><strong>Qtd. Solicitada:</strong> ${produto.QtdSolicitada}</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
